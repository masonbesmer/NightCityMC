#Name: extrabees.zs
#Author: Patch by JVital2013

print("Initializing 'extrabees.zs'...");
...
recipes.addShapeless(<thermalfoundation:material:0>, [<extrabees:misc:6>,<extrabees:misc:6>,<extrabees:misc:6>,<extrabees:misc:6>]);

print("Initialized 'extrabees.zs'");